...
| [the research console](https://maverickhq.github.io/prop-challenge-lab/report.html) | The whole register as one self-contained page — controls, findings against their floor, figures, provenance. Generated by `make report`, stamped with `engine_sha`; a dated artifact, not a live view. |
...
**Start with [RESULTS.md](RESULTS.md)** — the whole programme in one
checkable record: what was required, what nine axes returned, the three
results that looked real and were not, what the closing analysis corrected,
